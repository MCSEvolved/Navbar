...
class hc extends It {
  constructor(e) {
    super(), this.shadowRoot.innerHTML = "<style>header{position:absolute;top:0;left:0;z-index:1000;width:100vw}.bg-MCS-DarkerBlue{--tw-bg-opacity:1;background-color:rgb(13 29 48 / var(--tw-bg-opacity))}.h-14{height:3.5rem}.flex{display:flex}.items-center{align-items:center}.justify-between{justify-content:space-between}.w-80{width:20rem}.h-full{height:100%}.h-max{height:-moz-max-content;height:max-content}.ml-1{margin-left:0.25rem}.logo{height:2rem;margin-top:0.25rem;z-index:1001}.justify-end{justify-content:flex-end}</style>", re(
      this,
      {
        target: this.shadowRoot,
        props: Kt(this.attributes),
